...
readProgram:
    ...
    mov ax, 0x0210
    mov dx, 0x0080
    mov cx, 0x0010;0x1e00
    mov bx, 0x8004
    ;8000-адрес фреймбуфера (находится перед _start())
    int 0x13
    ;считывание ос
    ;mov ax, 0x020A;считать 0xA секторов
    mov ax, 0x0220;считать 0xA секторов
    mov dx, 0x0080
    mov cx, 0x0002;со 2 сектора
    mov bx, 0xc004
    int 0x13
ret
